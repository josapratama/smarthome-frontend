export const es = {
  ...
  noChannelsDescription: "Este dispositivo no tiene canales configurados",
  quickCommands: "Comandos Rápidos",
  failedToSendCommand: "Error al enviar comando",
  commandRetried: "Comando reintentado",
  failedToRetryCommand: "Error al reintentar comando",
  ...
  deviceConfigSaved: "Configuración del dispositivo guardada",
  failedToSaveConfig: "Error al guardar configuración",
  failedToLoadConfig: "Error al cargar configuración",
  configurationGuide: "Guía de Configuración",
  commonFields: "Campos Comunes",
  mqttSettings: "Configuración de conexión MQTT",
  wifiSettings: "Configuración de red WiFi",
  sensorConfiguration: "Array de configuración de sensores",
  actuatorConfiguration: "Array de configuración de actuadores",
  updateIntervalSeconds: "Intervalo de actualización en segundos",
  exampleConfig: "Configuración de Ejemplo",
  configHelpText:
    "Edite la configuración JSON con cuidado. JSON inválido no se guardará.",
  availableFirmware: "Firmware Disponible",
  updateHistory: "Historial de Actualizaciones",
  noFirmwareAvailable: "No hay versiones de firmware disponibles",
  noUpdateHistory: "No hay historial de actualizaciones",
  confirmFirmwareUpdate: "Confirmar Actualización de Firmware",
  firmwareUpdateWarning:
    "¿Está seguro de que desea actualizar el firmware? El dispositivo se reiniciará durante el proceso de actualización.",
  otaUpdateTriggered: "Actualización OTA iniciada",
  failedToTriggerUpdate: "Error al iniciar actualización",
  otaJobRetried: "Trabajo OTA reintentado",
  failedToRetryJob: "Error al reintentar trabajo",
  ...
  failedToUpdateChannel: "Error al actualizar canal",
  guestAccess: "Acceso de Invitado",
  viewHomesYouHaveAccessTo: "Ver casas a las que tiene acceso",
  waitForHomeInvitation: "Espere una invitación para acceder a una casa",
  viewYourNotifications: "Ver sus notificaciones",
  noNotificationsDesc: "Aún no tiene notificaciones",
  ...
  guestModeDesc:
    "Está viendo la aplicación en modo invitado con acceso limitado.",
  noAppInfoAvailable: "No hay información de la aplicación disponible",
  contactAdminForInfo: "Contacte al administrador para más información",
  selectThemePreference: "Seleccione su tema preferido",
  selectLanguage: "Seleccionar Idioma",
  receiveEmailUpdates: "Recibir actualizaciones por email",
  receivePushUpdates: "Recibir notificaciones push",
  notificationSettingsReadOnly:
    "La configuración de notificaciones es de solo lectura para usuarios invitados",
  limitedSettings: "Configuración Limitada",
  guestSettingsLimited:
    "Como invitado, solo puede cambiar la apariencia y el idioma.",
  viewYourProfileInfo: "Ver información de su perfil",
  profileNotFound: "Perfil no encontrado",
  unableToLoadProfile: "No se puede cargar su perfil",
  memberSince: "Miembro Desde",
  userId: "ID de Usuario",
  profileReadOnly: "Perfil de Solo Lectura",
  guestCannotEditProfile:
    "Los usuarios invitados no pueden editar su perfil. Contacte al administrador para cambios.",
  failedLoadDeviceData: "Error al cargar datos del dispositivo",
  deviceNotFoundDesc: "El dispositivo que busca no existe",
  viewOnlyMode: "Modo Solo Vista",
  guestCannotControlDevice:
    "Como invitado, puede ver información del dispositivo pero no controlarlo.",
  recentTelemetry: "Telemetría Reciente",
  noTelemetryDataDesc:
    "No hay datos de telemetría disponibles para este dispositivo",
  languageChanged: "Idioma cambiado exitosamente",
  themeChanged: "Tema cambiado exitosamente",
  failedLoadHomes: "Error al cargar casas",
  failedMarkAsRead: "Error al marcar como leído",
  failedDeleteNotification: "Error al eliminar notificación",
  failedLoadHomeData: "Error al cargar datos de la casa",
  homeInformation: "Información de la Casa",
  country: "País",
  noRoomsInHome: "No hay habitaciones en esta casa",
  noDevicesInHome: "No hay dispositivos en esta casa",
  ...
  success: "Éxito",
  inactive: "Inactivo",
  uploadFirstFirmware: "Suba su primer firmware para comenzar",
  commonRoom: "Habitación",
  unread: "No Leído",
  mqttId: "ID MQTT",
  moreDevices: "más dispositivos",
  privacySharedDesc: "Propietario y miembros seleccionados",
  privacyRestrictedDesc: "Solo propietario de la casa",
  accessOwner: "Propietario",
  accessView: "Ver",
  accessNone: "Ninguno",
  accessOwnerDesc: "Control total (editar, eliminar, dar acceso)",
  accessViewDesc: "Solo puede ver el estado",
  accessNoneDesc: "Sin acceso",
  notificationsWillAppear: "Las notificaciones aparecerán aquí",
  userPanel: "Panel de Usuario",
  adminPanel: "Panel de Administrador",
  user: "Usuario",
  realTimeSensorData: "Datos de sensores en tiempo real de sus dispositivos",
  live: "En Vivo",
  getStartedSmartHome: "Comenzar con Casa Inteligente",
  createHomeAddRooms: "Crear una casa y agregar habitaciones",
  pairESP32Devices: "Emparejar sus dispositivos IoT ESP32",
  monitorRealTimeTelemetry: "Monitorear telemetría en tiempo real",
  controlDevicesRemotely: "Controlar dispositivos remotamente",
  createFirstHome: "Crear Su Primera Casa",
  gas: "Gas",
  ...
  managePrivacyAndSecurity:
    "Gestionar su privacidad y configuración de seguridad",
  controlDataAndPrivacy:
    "Controlar sus datos, privacidad y seguridad de cuenta",
  profileVisibility: "Visibilidad del Perfil",
  controlWhoCanSeeProfile: "Controlar quién puede ver su perfil",
  showOnlineStatus: "Mostrar Estado En Línea",
  letOthersSeeOnline: "Permitir que otros vean cuando está en línea",
  showLocation: "Mostrar Ubicación",
  shareLocationInfo: "Compartir su información de ubicación",
  showActivity: "Mostrar Actividad",
  shareActivityStatus: "Compartir su estado de actividad",
  communicationPreferences: "Preferencias de Comunicación",
  controlWhoCanContact: "Controlar quién puede contactarlo",
  allowFriendRequests: "Permitir Solicitudes de Amistad",
  receiveFriendRequests: "Recibir solicitudes de amistad de otros usuarios",
  allowMessages: "Permitir Mensajes",
  receiveDirectMessages: "Recibir mensajes directos de otros usuarios",
  dataPrivacy: "Datos y Privacidad",
  manageDataCollection: "Gestionar recopilación y uso de datos",
  dataCollection: "Recopilación de Datos",
  allowDataCollection: "Permitir recopilación de datos para mejorar servicios",
  analyticsTracking: "Seguimiento de Analítica",
  allowAnalyticsTracking:
    "Permitir seguimiento de analítica para información de uso",
  manageYourData: "Gestionar sus datos personales",
  downloadMyData: "Descargar Mis Datos",
  downloadDataInfo:
    "Descargue una copia de sus datos personales en formato JSON. Esto incluye su perfil, dispositivos y configuración.",
  irreversibleActions: "Acciones irreversibles",
  deleteAllMyData: "Eliminar Todos Mis Datos",
  deleteDataWarning:
    "Advertencia: Esta acción eliminará permanentemente todos sus datos y no se puede deshacer.",
  dataDownloaded: "Datos descargados exitosamente",
  failedToDownloadData: "Error al descargar datos",
  deleteDataConfirm:
  ...
  privacyFeaturesComing: "Funciones de Privacidad Próximamente",
  privacyFeaturesDescription:
    "Estamos trabajando en controles de privacidad completos. Estas funciones estarán disponibles en una actualización futura.",
  comingSoon: "Próximamente",
  plannedFeatures: "Funciones Planificadas",
  backToSettings: "Volver a Configuración",
  enableSoundNotifications: "Notificaciones de Sonido",
  receiveEmailNotifications: "Recibir actualizaciones importantes por email",
  receivePushNotifications:
    "Obtener notificaciones instantáneas en su dispositivo",
  playSoundForNotifications: "Reproducir sonido cuando lleguen notificaciones",
  manageNotificationSettings: "Gestionar cómo recibe notificaciones",
  selectYourTimezone:
    "Seleccione su zona horaria para visualización precisa de tiempo",
  ...
  resetPreferencesConfirm:
    "¿Está seguro de que desea restablecer todas las preferencias a los valores predeterminados?",
  resetting: "Restableciendo...",
  failedToSaveSettings: "Error al guardar configuración",
  failedToResetSettings: "Error al restablecer configuración",
  roomAccess: "Acceso a Habitación",
  loginHistory: "Historial de Inicio de Sesión",
  loginRecords: "registros de inicio de sesión",
  loginTime: "Hora de Inicio de Sesión",
  attemptTime: "Hora de Intento",
  totalAttempts: "Total de Intentos",
  noLoginHistoryFound: "No se encontró historial de inicio de sesión",
  noLoginAttemptsFound: "No se encontraron intentos de inicio de sesión",
  failedToFetchLoginHistory: "Error al obtener historial de inicio de sesión",
  failedToFetchLoginAttempts: "Error al obtener intentos de inicio de sesión",
  failedToFetchSessions: "Error al obtener sesiones",
  failedToRevokeSession: "Error al revocar sesión",
  activeSessions: "Sesiones Activas",
  activeSessionsCount: "sesiones activas",
  revokeSession: "Revocar Sesión",
  sessionRevokedSuccess: "Sesión revocada exitosamente",
  revokeSessionConfirm:
    "¿Está seguro de que desea revocar esta sesión? El usuario será desconectado inmediatamente.",
  ...
  requireSpecialCharacters: "Requerir Caracteres Especiales",
  requireNumbers: "Requerir Números",
  requireUppercase: "Requerir Letras Mayúsculas",
  roomAccessControl: "Control de Acceso a Habitación",
  roomAccessControlDesc:
    "Gestionar niveles de privacidad de habitación, permisos de acceso y monitorear registros de acceso",
  access: "Acceso",
  accessGrants: "Permisos de Acceso",
  roomPrivacy: "Privacidad de Habitación",
  accessLogs: "Registros de Acceso",
  activeGrants: "permisos activos",
  grantAccess: "Otorgar Acceso",
  failedFetchAccessGrants: "Error al obtener permisos de acceso",
  accessGrantRevokedSuccess: "Permiso de acceso revocado exitosamente",
  failedRevokeGrant: "Error al revocar permiso",
  grantedBy: "Otorgado Por",
  grantedAt: "Otorgado En",
  expires: "Expira",
  never: "Nunca",
  noAccessGrantsFound: "No se encontraron permisos de acceso",
  grantRoomAccess: "Otorgar Acceso a Habitación",
  grantRoomAccessDesc:
    "Otorgar a un usuario acceso a una habitación específica con permisos definidos",
  selectUser: "Seleccionar usuario",
  bedroom: "Dormitorio",
  selectAccessLevel: "Seleccionar nivel de acceso",
  ownerFullControl: "Propietario - Control total",
  controlCanControlDevices: "Control - Puede controlar dispositivos",
  viewReadOnly: "Ver - Solo lectura",
  failedFetchAccessLogs: "Error al obtener registros de acceso",
  noAccessLogsFound: "No se encontraron registros de acceso",
  failedFetchRooms: "Error al obtener habitaciones",
  roomPrivacyUpdatedSuccess:
    "Nivel de privacidad de habitación actualizado exitosamente",
  failedUpdatePrivacyLevel: "Error al actualizar nivel de privacidad",
  roomPrivacySettings: "Configuración de Privacidad de Habitación",
  grants: "Permisos",
  updateRoomPrivacy: "Actualizar Privacidad de Habitación",
  changePrivacyLevelFor: "Cambiar el nivel de privacidad para",
  privacyLevel: "Nivel de Privacidad",
  publicAllHomeMembersCanAccess:
    "Público - Todos los miembros de la casa pueden acceder",
  sharedOwnerPlusSelectedMembers:
    "Compartido - Propietario + miembros seleccionados",
  privateOnlyOwnerPlusGrantedUsers:
    "Privado - Solo propietario + usuarios con permiso explícito",
  restrictedOnlyHomeOwnerAdmin:
    "Restringido - Solo propietario/administrador de la casa",
  updatePrivacy: "Actualizar Privacidad",
  passwordExpiry: "Expiración de Contraseña (días)",
  securityNotice: "Aviso de Seguridad",
  securityNoticeMessage:
    "Los cambios en la configuración de seguridad afectarán a todos los usuarios. Asegúrese de comunicar cualquier cambio de política a su equipo.",
  saveSettings: "Guardar Configuración",
  securitySettingsUpdated:
    "La configuración de seguridad se ha actualizado exitosamente",
  manageSecuritySettings: "Gestionar configuración de seguridad",
  securitySettings: "Configuración de Seguridad",
  manageLoginAndSessions:
    "Gestionar historial de inicio de sesión y sesiones activas",
  noActiveSessionsFound: "No se encontraron sesiones activas",
  actions: "Acciones",
  failedAttempts: "Intentos Fallidos",
  securityPageDescription:
    "Monitorear actividad de inicio de sesión, gestionar sesiones y configurar ajustes de seguridad",
  maxLoginAttemptsDesc:
    "Número de intentos de inicio de sesión fallidos antes del bloqueo de cuenta",
  lockoutDurationDesc:
    "Cuánto tiempo permanece bloqueada una cuenta después de los intentos máximos",
  sessionTimeoutDesc:
    "Cierre de sesión automático después de período de inactividad",
  emailVerificationDesc:
    "Los usuarios deben verificar el email antes de iniciar sesión",
  twoFactorDesc: "Requerir 2FA para todos los usuarios",
  specialCharsDesc: "La contraseña debe contener !@#$%^&*",
  numbersDesc: "La contraseña debe contener al menos un número",
  uppercaseDesc: "La contraseña debe contener letras mayúsculas",
  passwordExpiryDesc:
    "Los usuarios deben cambiar la contraseña después de este período (0 = nunca)",
  ...
  errorPersists: "Si este error persiste, por favor contacte a soporte.",
  pageNotFound: "Página No Encontrada",
  pageNotFoundDesc: "La página que busca no existe o ha sido movida.",
  suggestions: "Sugerencias",
  checkUrlSpelling: "Verifique la ortografía de la URL",
  pageMovedOrDeleted: "La página puede haber sido movida o eliminada",
  useNavigationMenu: "Use el menú de navegación para encontrar lo que necesita",
  goBack: "Volver",
  aiPredictions: "Predicciones de IA",
  anomalyType: "Tipo",
  anomalyDevice: "Dispositivo",
  ruleAction: "Acción",
  createAlarm: "Crear Alarma",
  logEvent: "Registrar Evento",
  ruleValue: "Valor",
  modelDeactivated: "Modelo desactivado exitosamente",
  createPredictionModel: "Crear Modelo de Predicción",
  createAnomalyModel: "Crear Modelo de Anomalía",
  createAnomalyModelDescription:
    "Crear un nuevo modelo de IA para detección de anomalías",
  predictionModels: "Modelos de Predicción",
  anomalyModels: "Modelos de Anomalía",
  isolationForest: "Bosque de Aislamiento",
  oneClassSvm: "SVM de Una Clase",
  localOutlierFactor: "Factor de Valor Atípico Local",
  inUse: "En Uso",
  activate: "Activar",
  ...
  landingDescription:
    "Gestiona todos tus dispositivos IoT desde una plataforma segura y fácil de usar. Monitorea, controla y automatiza tu casa inteligente con facilidad.",
  securePrivate: "Seguro y Privado",
  secureDesc:
    "Seguridad de nivel empresarial con cifrado de extremo a extremo para proteger tus datos.",
  realTimeControl: "Control en Tiempo Real",
  realTimeDesc:
    "Controla y monitorea dispositivos en tiempo real desde cualquier lugar.",
  roleBasedAccess: "Acceso Basado en Roles",
  roleBasedDesc:
    "Sistema de gestión de usuarios con control de acceso basado en roles para máxima seguridad.",
  roleBasedAccessDesc:
    "Sistema de gestión de usuarios con control de acceso basado en roles para máxima seguridad.",
  automationDesc:
    "Crea automatizaciones inteligentes y escenas para que tu hogar trabaje para ti.",
  energyMonitoringDesc:
    "Rastrea el consumo de energía y optimiza la eficiencia de tu hogar.",
  multiDevice: "Soporte Multi-dispositivo",
  multiDeviceDesc:
    "Soporte para varios dispositivos IoT y protocolos en una sola plataforma.",
  readyToStart: "¿Listo para Comenzar?",
  readyDesc: "Únete a miles de usuarios que confían en Smart Home",
  alreadyHaveAccount: "¿Ya tienes una cuenta?",

  // Public Pages Extended
  noPublicHomesDescription:
    "Los hogares públicos aparecerán aquí cuando estén disponibles",
  noPublicDevicesDescription:
    "Los dispositivos públicos aparecerán aquí cuando estén disponibles",
  ...
  welcomeToSmartHome: "Bienvenido a Smart Home",
  loginDescription:
    "Gestiona todos tus dispositivos IoT desde una plataforma segura y fácil de usar.",
  securePrivateDesc:
    "Seguridad de nivel empresarial con cifrado de extremo a extremo para proteger tus datos.",
  realtimeControl: "Control en Tiempo Real",
  realtimeControlDesc:
  ...
  footerText: "Plataforma Smart Home. Todos los derechos reservados.",

  // Register Extended
  createAccount: "Crear Cuenta",
  registerDesc: "Regístrate para comenzar a usar Smart Home",
  registerWithGoogle: "Regístrate con Google",
  orRegisterWith: "O regístrate con correo electrónico",
  ...
  forgotPasswordDesc:
    "Ingresa tu correo. Te enviaremos instrucciones de restablecimiento.",
  ...
  didntReceiveEmail:
    "¿No recibiste el correo? Revisa la carpeta de spam / espera unos minutos.",
  failedSendResetRequest: "Error al enviar solicitud de restablecimiento",

  // Reset Password Extended
  resetPasswordDesc:
    "Ingresa el token de restablecimiento y la nueva contraseña.",
  resetToken: "Token de restablecimiento",
  pasteTokenFromEmail: "pega el token del correo",
  tokenHint:
    "El token suele estar en el enlace del correo. Ejemplo: /reset-password?token=...",
  repeatNewPassword: "repetir nueva contraseña",
  confirmMismatch: "La confirmación no coincide.",
  tokenRequired: "Se requiere el token de restablecimiento.",
  passwordResetSuccess: "Contraseña cambiada exitosamente",
  passwordResetSuccessDesc: "Por favor inicia sesión con tu nueva contraseña.",
  resetPasswordFailed: "Error al restablecer contraseña",
  processing: "Procesando...",
  resetPasswordButton: "Restablecer contraseña",
  resetPasswordHelpText:
    "Si aún tienes problemas, solicita un nuevo restablecimiento desde el menú de olvidé mi contraseña.",
